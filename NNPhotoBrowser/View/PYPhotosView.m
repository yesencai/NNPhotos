...
@interface PYPhotosView()<PYPhotoViewDelegate>
...
- (void)photoView:(PYPhotoView *)photoView didDeleteImageWithImages:(NSMutableArray *)images index:(NSInteger)index{
    if ([self.delegate respondsToSelector:@selector(photosView:didDeleteImageWithImages:index:)]) {
        [self.delegate photosView:self didDeleteImageWithImages:images index:index];
    }
