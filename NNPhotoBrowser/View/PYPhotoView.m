...
- (void)deleteImage
{
    ...
    if ([self.delegate respondsToSelector:@selector(photoView:didDeleteImageWithImages:index:)]) {
        [self.delegate photoView:self didDeleteImageWithImages:self.images index:self.tag];
    }
}
